...
The **1.8.Soma_neurites** workflow produces an instance segmentation of the **soma** and of the **neurites** from pre-segmented neuron cell_mask. This workflow differs from workflows 1.0-1.7 as it does not use an intensity image as the input, but a segmented cell_mask image, such as the output from one of the 1.1 workflow outputs.
